...
const TIER_LABELS = {
    under25: 'Observance : moins de 25%',
    '25to50': 'Observance : 25 – 50%',
    '50to75': 'Observance : 50 – 75%',
    over75: 'Observance : plus de 75%',
};
...
export default function PatientsIndex({ patients, initialObservanceTier }) {
    ...
    return (
        <PraticienLayout title="Patients">
            <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
                <h1 className="font-display text-2xl font-semibold text-forest">Patients</h1>
            ...
            {hasNoPatientsAtAll && (
                <div className="rounded-2xl bg-white px-6 py-16 text-center">
                    ...
                    <p className="mb-1 text-base font-semibold text-forest">Aucun patient pour l’instant</p>
                    <p className="text-sm text-forest/60">Créez votre premier patient avec le bouton ci-dessus.</p>
                </div>
            )}

            {filterHasNoResults && (
                <div className="rounded-2xl bg-white px-5 py-14 text-center">
                    <p className="mb-1 text-base font-semibold text-forest">Aucun patient dans ce filtre</p>
                    <p className="text-sm text-forest/60">Essayez un autre filtre, ou revenez à « Tous ».</p>
                </div>
            )}
